...
func dedupRefToImage(refToImage map[name.Reference]v1.Image) map[v1.Image][]string {
	...
	for ref, img := range refToImage {
		if tag, ok := ref.(name.Tag); ok {
			...
			// https://github.com/thesavant42/yolosint/pkg/forks/github.com/google/go-containerregistry/issues/890
			//
			// We can't use the fully qualified tag.Name() because of rules_docker:
			// https://github.com/thesavant42/yolosint/pkg/forks/github.com/google/go-containerregistry/issues/527
			//
