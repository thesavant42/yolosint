...
func TestGetSchema1(t *testing.T) {
	...
	want := `unsupported MediaType: "application/vnd.docker.distribution.manifest.v1+prettyjws", see https://github.com/thesavant42/yolosint/pkg/forks/github.com/google/go-containerregistry/issues/377`
