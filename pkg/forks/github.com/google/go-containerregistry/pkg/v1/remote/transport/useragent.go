...
var (
	...
	// -ldflags="-X 'github.com/thesavant42/yolosint/pkg/forks/github.com/google/go-containerregistry/pkg/v1/remote/transport.Version=$TAG'"
	Version string
...
const (
	...
	moduleName       = "github.com/thesavant42/yolosint/pkg/forks/github.com/google/go-containerregistry"
)
