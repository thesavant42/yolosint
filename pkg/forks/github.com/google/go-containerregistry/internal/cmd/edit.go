...
import (
	...
	"github.com/thesavant42/yolosint/pkg/forks/github.com/google/go-containerregistry/internal/editor"
	...
	"github.com/thesavant42/yolosint/pkg/forks/github.com/google/go-containerregistry/pkg/v1/static"
...
func editConfig(in io.Reader, out io.Writer, src, dst string, options ...crane.Option) (name.Reference, error) {
	...
	if m.Config.Data != nil && verify.Descriptor(m.Config) == nil {
		// https://github.com/thesavant42/yolosint/pkg/forks/github.com/google/go-containerregistry/issues/1552#issuecomment-1452653875
